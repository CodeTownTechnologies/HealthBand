        ...
        <View style={styles.listItem}>
            <View style={styles.listItemStyle}>
                <View style={{ flex: 1, marginLeft: 10, padding: 10 }}>
                    ...
                    <Text style={{ color: '#808080', fontSize: RFValue(12, 580) }}>{item.ble_mac}</Text>
                    <Text style={{ color: '#808080', fontSize: RFValue(12, 580) }}>{item.gender == 1 ? 'Male' : 'Female'}</Text>
                    <Text style={{ color: "#949494", alignSelf: 'flex-end', marginTop: 10, fontSize: RFPercentage(1.5) }}>{item.dob}</Text>
                </View>
